...
! Mathematical and Physical constants in default precision : Addition to the module by Martin Leib

public:: PI
public:: ID_2, SIGMA_Z, SIGMA_P, SIGMA_M, SIGMA_X, SIGMA_Y, UP, DOWN
!-----------------------------------------------------------------------------------------------------------------------------------
...
real(R_P), parameter ::  PI = 4_R_P * atan(1.0_R_P)
complex(R_P), dimension(2,2), parameter :: ID_2 = reshape((/(1.0, 0.0_R_P),(0.0,0.0_R_P),(0.0,0.0_R_P),(1.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2,2), parameter :: SIGMA_Z = reshape((/(1.0, 0.0_R_P),(0.0,0.0_R_P),(0.0,0.0_R_P),(-1.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2,2), parameter :: SIGMA_M = reshape((/(0.0, 0.0_R_P),(1.0,0.0_R_P),(0.0,0.0_R_P),(0.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2,2), parameter :: SIGMA_P = reshape((/(0.0, 0.0_R_P),(0.0,0.0_R_P),(1.0,0.0_R_P),(0.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2,2), parameter :: SIGMA_X = reshape((/(0.0, 0.0_R_P),(1.0,0.0_R_P),(1.0,0.0_R_P),(0.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2,2), parameter :: SIGMA_Y = reshape((/(0.0, 0.0_R_P),(0.0,1.0_R_P),(0.0,-1.0_R_P),(0.0,0.0_R_P)/),(/2,2/))
complex(R_P), dimension(2), parameter :: UP = (/(1.0,0.0_R_P),(0.0,0.0_R_P)/)
complex(R_P), dimension(2), parameter :: DOWN = (/(0.0,0.0_R_P),(1.0,0.0_R_P)/)
